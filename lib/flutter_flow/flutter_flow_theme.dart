...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3F24A6);
  late Color secondary = const Color(0xFF818CF8);
  late Color tertiary = const Color(0xFF2DD4BF);
  late Color alternate = const Color(0xFFFB7185);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFCBD5E1);
  late Color primaryBackground = const Color(0xFF2E2E5C);
  late Color secondaryBackground = const Color(0xFF2E2E5C);
  late Color accent1 = const Color(0xFFFFAB40);
  late Color accent2 = const Color(0xFF8E24AA);
  late Color accent3 = const Color(0xFF00BCD4);
  late Color accent4 = const Color(0xFFFF5252);
  ...
  late Color info = const Color(0xFF29B6F6);

  late Color lightVibrantColor = const Color(0xFFF8E6BE);
  late Color mutedColor = const Color(0xFF9B5F6B);
  late Color lightMutedColor = const Color(0xFFC4AEB6);
  late Color darkMutedColor = const Color(0xFF39404C);
}
